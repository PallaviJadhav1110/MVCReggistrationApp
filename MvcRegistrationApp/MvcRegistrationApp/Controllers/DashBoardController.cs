    ...
    public class DashBoardController : Controller
    {
        ...
        public ActionResult DisplayDashBoard()
        {
            if (UserId > 0)
            {
                ...
                summary.ExistingEngagementList = db.GetEngagementList_ExistingOrOverInCurrentWeek("ExistingEngagement");
                summary.ListEngagementsOverInCurrentWeek = db.GetEngagementList_ExistingOrOverInCurrentWeek("EngagementsOverInCurrentweek");
        ...
        public ActionResult ExportDataExistingEngagements()
        {
            if (UserId > 0)
            {
                ...
                try
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment; filename=ExistingEngagement.xls");
        ...
        public ActionResult GetExisting_CurrentEngagement(string id)
        {
            if (UserId > 0)
            {
                EngagementSummary summary = new EngagementSummary();
                ...
                DashBoard db = new DashBoard();
                summary.ExistingEngagementList = db.GetEngagementList_ExistingOrOverInCurrentWeek(id);
                ...
                else 
                {
                        ...
                        return PartialView("EngagementOverInNextWeek", summary.ExistingEngagementList);
